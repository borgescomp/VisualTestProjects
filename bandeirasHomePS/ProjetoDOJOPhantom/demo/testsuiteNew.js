...
var html = fs.read( fs.absolute( fs.workingDirectory + '/coffeemachine.html' ));
...
casper.test.begin( 'Bandeiras da home', function ( test ) {
	...
	*/
	...
	casper.start( 'https://pagseguro.uol.com.br/' );

	casper.viewport( 1024, 768 );

	casper.then( function () {
		phantomcss.screenshot( '#flags', 'Bandeiras da home' );
	} );

	casper.then( function () {
		casper.click( '#venda-internet' );
